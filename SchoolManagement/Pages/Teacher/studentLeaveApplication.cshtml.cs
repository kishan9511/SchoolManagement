...
{
    public class studentLeaveApplicationModel : PageModel
    {
        public readonly SchoolManagementContext _db;
        public studentLeaveApplicationModel(SchoolManagementContext db)
        {
            _db = db;
        }

        public IEnumerable<leave_Model> StudentLeaveDatalist { get; set; }
        ...
        public IActionResult OnGet(int? id)
        {
            ...
            StudentLeaveDatalist = _db.Leaves.Where(r => r.Isdeleted == false).Select(r => new leave_Model
            {
                ID = r.Id,
